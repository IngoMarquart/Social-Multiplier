...
% This version takes a restricted p vector, prest, containing weights only for neighbors in G
% such that the matlab minimizer does not try to optimize over non-neighbors.
%
% The prest variable is then up-calculated to the full p_i
...
% @return: x - Afaik this is the variable set by the minimizer?
%% 
